import { lineTypeIcon } from '@editor/constants/icons'
...
const LineTypeField = ({ selectedSettings, setSelectedSettings, disabled = false, values, defaultValue, valueChanged }: LineTypeType) => {
