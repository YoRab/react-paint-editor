  ...
  <div className="sb-section">
    <div className="sb-section-item">
      ...
      <ul>
        ...
        <li><code>swapShapes</code> - Function to swap 2 shapes in layer order</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Brush rendering algorithm: <code>'simple'</code> uses raw path, <code>'quadratic'</code> uses quadratic Bézier curves</td>
