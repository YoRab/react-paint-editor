  ...
  return (
    <Editor editorProps={editorProps}>
      ...
      <ul>
        ...
        <li><strong>Debug</strong> - Enable <code>options.debug: true</code> to log shape selection and hit-testing to the browser console</li>
      </ul>
...
link.click()`} />
    ...
    <Source language='typescript' code={`const { editorProps, canvasProps } = useReactPaint({
      ...
      <ul>
        ...
        <li>Review the <LinkTo title='API Reference' story='docs'>API documentation</LinkTo> for detailed type definitions and advanced features</li>
