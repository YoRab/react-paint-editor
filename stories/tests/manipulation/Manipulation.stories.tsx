...
// Rect at x=100, y=100, width=200, height=200 → center=(200,200).
...
export const Grid: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // =====================================================================
    // Test 1: No grid
    // roundForGrid(228, 0)=228, roundForGrid(200, 0)=200 → delta=28, new x=128
    // =====================================================================
    await selectRect()
    await translateRect()
    ...
    // roundForGrid(228, 10)=230, roundForGrid(200, 10)=200 → delta=30, new x=130
    // =====================================================================
    await setGrid('S')
    await selectRect()
    await translateRect()
    ...
    // roundForGrid(228, 20)=220, roundForGrid(200, 20)=200 → delta=20, new x=120
    // =====================================================================
    await setGrid('M')
    await selectRect()
    await translateRect()
    ...
    // roundForGrid(228, 40)=240, roundForGrid(200, 40)=200 → delta=40, new x=140
    // =====================================================================
    await setGrid('L')
    await selectRect()
    await translateRect()
